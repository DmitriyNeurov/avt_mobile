...
public class WelcomePageObject extends MainPageObject
{
    ...
    STEP_MORE_LEARN_ABOUT_DATA_COLLECTED_LINK = "id:Learn more about data collected",
    NEXT_LINK = "id:Next",
    ...
    {
        this.waitForElementPresent(STEP_MORE_LEARN_ABOUT_DATA_COLLECTED_LINK, "Cannot find 'Learn more about data collected' link", 10);
    }
